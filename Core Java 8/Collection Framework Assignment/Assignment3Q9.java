...
public class Assignment3Q9 {
	public static void main(String[] args) {
		...
		SavingAccount sAccount1 = new SavingAccount(150000, 1, "Ram", true);
		SavingAccount sAccount2 = new SavingAccount(25000.50, 2, "Bravo", false);
		SavingAccount sAccount3 = new SavingAccount(330000.75, 3, "Charlie", true);
